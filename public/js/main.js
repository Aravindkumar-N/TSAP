...
function updatePlaceholder() {
    ...
    if (idTypeSelect.value === "PESEL") {
        idInput.placeholder = "Enter PESEL";
        idInput.setAttribute("data-id-type", "PESEL");
    } else if (idTypeSelect.value === "NIP") {
        idInput.placeholder = "Enter NIP";
        idInput.setAttribute("data-id-type", "NIP");
    }
}

document.getElementById("idTypeSelect").addEventListener("change", updatePlaceholder);
