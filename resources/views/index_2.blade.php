...
<div class="heading-map">
	...
	<div class="logos">
		<div class="logo1">
			<div><img src="{{asset('images/map/logo1.png')}}" alt="	"></div>
		...
		<div class="logo1">
			<div><img src="{{asset('images/map/logo2.png')}}" alt=""></div>
		...
		<div class="logo1">
			<div><img src="{{asset('images/map/logo3.png')}}" alt=""></div>
		...
		<div class="logo1">
			<div><img src="{{asset('images/map/logo4.png')}}" alt=""></div>
