...
<div class="page-wraper">
	...
	<!-- Construction -->
	<div class="under-construction overlay-white-dark background-luminosity" style="background-image:url('images/background/.jpg'); background-position: center;">
		
		<div class="inner-construction">
		
			<div class="logo-header clearfix">
				<a href="index.html"><img src="images/tamil_logo1.png" alt=""></a>
			</div>
            <div class="content">
            <h1>Tamil Sangam Association of Poland(TSAP)</h1>
			<p>Stay updated with the latest announcements and important information from Tamil Sangam. Our Notice Board provides timely updates on events, meetings, and other significant news relevant to everyone. Check this space regularly to stay informed about what’s happening.</p>
