            ...
            <div class="col-lg-6 m-b30 wow fadeInUp" data-wow-delay="0.2s">
                <div class="inner-content">
                    <div class="section-head">
                        ...
                        <p class="max-w600">
                            Tamil Nadu offers a vibrant and dynamic environment
                            for business and investment, making it an ideal
                            destination for international investors.
                        </p>
                        <p class="max-w600">
                            Tamil Sangam Association Poland, is dedicated to
                            promoting and supporting investors to invest in
                            Tamil Nadu. Our goal is to streamline the investment
                            process, making it as efficient and straightforward
                            as possible.
                        </p>
                        <p class="max-w600" id="bold">
                        <b>For detailed information and assistance on
                            investment opportunities in Tamil Nadu, please
                            contact our Business Development Executive Mr.Suresh
                            Nallasivam</b>
                        </p>
                    </div>
...
<div class="city">
    <section class="content-inner-3 section-pattren1">
        <div class="container">
            <div
                class="section-head text-center wow fadeInUp"
                data-wow-delay="0.1s"
            >
            ...
            <div class="swiper team-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div
                            class="dz-team style-1 m-b30 wow fadeInUp"
                            data-wow-delay="0.1s"
                        >
                            <div class="dz-media">
                            ...
                            <div class="dz-content">
                                ...
                                <span class="dz-position text-primary"
                                    >Capital city of Tamilnadu</span
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        >
                            ...
                            <div class="dz-content">
                                ...
                                <span class="dz-position text-primary"
                                    >The Queen of hill stations</span
                                >
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        ...
                        >
                            ...
                            <div class="dz-content">
                                ...
                                <span class="dz-position text-primary"
                                    >The Princess of Hill stations</span
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        >
                            ...
                            <div class="dz-content">
                                ...
                                <span class="dz-position text-primary"
                                    >Sleepless City of Tamilnadu</span
                                >
                            </div>
                        </div>
                    </div>
        ...
        >
            ...
            />
            <path
                d="M2 46L15.744 33.736C18.6614 31.1328 23.1457 31.4241 25.7017 34.383L30.3669 39.7835C33.1839 43.0444 38.2501 43.0101 41.0227 39.7114L44.878 35.1246C47.6031 31.8824 52.5608 31.7841 55.4124 34.9157L59.9639 39.9144C62.8687 43.1045 67.9399 42.9329 70.6223 39.5537L79 29"
                stroke="var(--primary)"
                stroke-width="5"
            />
        </svg>
        <svg
            class="shape-2 rotating"
            viewBox="0 0 95 95"
            xmlns="http://www.w3.org/2000/svg"
            xmlns:v="https://vecta.io/nano"
            width="95"
        ...
        >
            <g opacity="0.2">
                <rect
                    ...
                    width="15.3997"
                    height="89.934"
                    transform="rotate(18.3505 63.3936 11.6357)"
                    fill="var(--primary)"
                ></rect>
                <rect
                    x="93.6138"
                    ...
                    width="15.3997"
                    height="89.934"
                    transform="rotate(63.3505 93.6138 30.0967)"
                    fill="var(--primary)"
                ></rect>
                <rect
                    width="15.3997"
                    height="89.934"
                    transform="matrix(0.314829 -0.949148 -0.949148 -0.314829 96.9966 78.5947)"
                    fill="var(--primary)"
                ></rect>
                <rect
                    width="15.3997"
                    height="89.934"
                    transform="matrix(0.893767 -0.448532 -0.448532 -0.893767 70.1479 100.841)"
                    fill="var(--primary)"
                ></rect>
            </g>
        </svg>
        <svg
            class="shape-3 rotating"
            xmlns="http://www.w3.org/2000/svg"
            width="114"
            height="114"
            viewBox="0 0 114 114"
