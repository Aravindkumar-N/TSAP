...
@section('content')
	...
	<div class="page-content bg-white">
		...
		<!-- About Us -->
		<section class="content-inner section-wrapper5">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div class="icon-bx-wraper box-hover style-2 m-b30">
							...
							<div class="icon-content">
								<h5 class="dz-tilte m-b10 text-capitalize">Quo maxime qui impedit odio soluta</h5>
					...
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div class="icon-bx-wraper box-hover style-2 m-b30">
							...
							<div class="icon-content">
								<h5 class="dz-tilte m-b10 text-capitalize">Ut nisi ea vero itaque error magnam</h5>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do labore et dolore magna aliqua. </p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div class="icon-bx-wraper box-hover style-2 m-b30">
							...
							<div class="icon-content">
								<h5 class="dz-tilte m-b10 text-capitalize">Quaerat nobis est</h5>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do labore et dolore magna aliqua. </p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div class="icon-bx-wraper box-hover style-2 m-b30">
							...
							<div class="icon-content">
								<h5 class="dz-tilte m-b10 text-capitalize">Deleniti iure ipsa eos eaque under</h5>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed dolabore et dolore magna aliqua. </p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-7 m-b50">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-sm-4 col-12 m-b30">
								<h2>$ <span class="counter">195,234</span></h2>
						...
						<div class="swiper-slide">
							<div class="dz-team style-1 m-b30 wow fadeInUp" data-wow-delay="0.1s">
								...
								<div class="dz-content">
									<h5 class="dz-name">K. YUSUF MASTHAN</h5>
									<span class="dz-position text-primary">Founder & President</span>
								</div>
							</div>
						</div>
						<div class="swiper-slide">
							<div class="dz-team style-1 m-b30 wow fadeInUp" data-wow-delay="0.2s">
								...
								<div class="dz-content">
									<h5 class="dz-name">SRUTHI SABAREESAN</h5>
									<span class="dz-position text-primary">Vice President</span>
								</div>
							</div>
						</div>
						<div class="swiper-slide">
